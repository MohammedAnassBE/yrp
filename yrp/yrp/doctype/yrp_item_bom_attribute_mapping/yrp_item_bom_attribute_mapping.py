...
from yrp.yrp.doctype.yrp_item.yrp_item import get_attribute_values as get_item_attribute_values, get_attributes

class YRPItemBOMAttributeMapping(Document):
	def validate(self):
		...
		if same_attributes and len(same_attributes) > 0:
			item_attributes = get_item_attribute_values(self.item, same_attributes)
...
ItemBOMAttributeMapping = YRPItemBOMAttributeMapping
