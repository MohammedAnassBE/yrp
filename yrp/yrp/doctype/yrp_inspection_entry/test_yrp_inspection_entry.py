...
def _configure_approver_role(role="System Manager"):
	...
	return patch(
		"yrp.yrp.doctype.yrp_inspection_entry.yrp_inspection_entry._approver_role",
		return_value=role,
	)
...
class TestInspectionEntry(FrappeTestCase):
	...
	def test_05_convert_stock_writes_sles_and_flips_flag(self):
		...
		from yrp.yrp.doctype.yrp_inspection_entry.yrp_inspection_entry import convert_stock
