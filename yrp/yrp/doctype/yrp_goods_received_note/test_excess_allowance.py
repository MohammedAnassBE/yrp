...
def _set_po_excess(item_variant, pct):
	...
	frappe.db.set_value('YRP Item', parent_item, "po_excess_allowed_percentage", pct)
	frappe.clear_cache(doctype='YRP Item')
...
class TestGRNExcessAllowance(FrappeTestCase):
	...
	def test_05_wo_within_allowance_succeeds(self):
		...
		frappe.db.set_value('YRP Supplier', sender, "is_company_location", 0)
