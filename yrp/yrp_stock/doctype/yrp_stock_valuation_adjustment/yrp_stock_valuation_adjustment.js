frappe.ui.form.on("YRP Stock Valuation Adjustment", {
	refresh(frm) {
		...
		frm.add_custom_button(__("Retry Valuation"), () => {
			frappe.call({
				method: "yrp.yrp_stock.doctype.yrp_stock_valuation_adjustment.yrp_stock_valuation_adjustment.retry_adjustment",
