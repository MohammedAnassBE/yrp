...
class YRPRepostItemValuation(Document):
	def validate(self):
	...
	def on_submit(self):
		...
		frappe.enqueue(
			"yrp.yrp_stock.doctype.yrp_repost_item_valuation.yrp_repost_item_valuation.repost",
			doc=self.name,
			queue=queue,
			timeout=3600,
...
RepostItemValuation = YRPRepostItemValuation
